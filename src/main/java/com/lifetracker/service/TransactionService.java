...
public class TransactionService {
    ...
    public Map<String, BigDecimal> getExpensesByCategory(Long userId, LocalDate startDate, LocalDate endDate) {
        return getExpensesByDateRange(userId, startDate, endDate).stream()
    ...
    public Map<String, BigDecimal> getIncomeBySource(Long userId, LocalDate startDate, LocalDate endDate) {
        return getIncomesByDateRange(userId, startDate, endDate).stream()
                .collect(Collectors.groupingBy(
                        Income::getSource,
