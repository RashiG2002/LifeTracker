...
public class PageController {
    ...
    public String transactionsPage(@RequestParam(value = "month", required = false) String month,
        ...
        if (startDate != null && endDate != null) {
            model.addAttribute("expenses", transactionService.getExpensesByDateRange(userId, startDate, endDate));
            model.addAttribute("incomes", transactionService.getIncomesByDateRange(userId, startDate, endDate));
            model.addAttribute("totalIncome", transactionService.getTotalIncomeByDateRange(userId, startDate, endDate));
            model.addAttribute("totalExpenses", transactionService.getTotalExpensesByDateRange(userId, startDate, endDate));
            BigDecimal income = transactionService.getTotalIncomeByDateRange(userId, startDate, endDate);
            BigDecimal expense = transactionService.getTotalExpensesByDateRange(userId, startDate, endDate);
            model.addAttribute("balance", income.subtract(expense));
